...
type BuyEvent struct {
	...
	BuybackFeeBasisPoints            uint64             `json:"buybackFeeBasisPoints"`
	BuybackFee                       uint64             `json:"buybackFee"`
}
...
type FeeConfig struct {
	...
	StableFeeTiers []FeeTier          `json:"stableFeeTiers"`
}
...
type GlobalConfig struct {
	...
	BuybackFeeRecipients         [8]solanago.PublicKey `json:"buybackFeeRecipients"`
	BuybackBasisPoints           uint64                `json:"buybackBasisPoints"`
}
